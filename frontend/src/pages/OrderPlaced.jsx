...
function OrderPlaced() {
  ...
  return (
    <div className='min-h-screen bg-[#fff9f6] flex flex-col justify-center items-center px-4 text-center relative overflow-hidden'>
        ...
        <p className='text-gray-600 max-w-md mb-6'>Thank you for your purchase. Your order is being ready. You can track your order status in the "My Orders" section.</p>
