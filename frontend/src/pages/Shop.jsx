        ...
        <span>Back</span>
            ...
            {shop && <div className='relative w-full h-64 md:h-80 lg:h-96'>
                ...
                <div className='absolute inset-0 bg-gradient-to-b from-black/70 to-black/30 flex flex-col justify-center items-center text-center px-4 '>
                    <GiFarmer className='text-white text-4xl mb-3 drop-shadow-md' />
            ...
            <div className='max-w-7xl mx-auto px-6 py-10'>
                <h2 className='flex items-center justify-center gap-3 text-3xl font-bold mb-10 text-gray-800'> <FaSeedling color='red'/>Our Products Menu</h2>
