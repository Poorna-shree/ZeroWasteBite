...
function OwnerDashboard() {
  ...
  return (
    <div className='w-full min-h-screen bg-[#fff9f6] flex flex-col items-center'>
      ...
      {/* If no shop data - show "Get Started" card */}
      {!myShopData && (
        <div className='flex justify-center items-center p-4 sm:p-6'>
          <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              <LuVegan className='text-[#ff4d2d] w-16 h-16 sm:h-20 mb-4' />
              <h2 className='text-xl sm:text-2xl font-bold text-gray-800 mb-2'>
                Add your products
              </h2>
              <p className='text-gray-600 mb-4 text-sm sm:text-base'>
                Join our ZeroWasteBite platform and reach thousands of Restaurants,
                Event Managers and other customers every day.
              </p>
              <button
                className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font shadow-md hover:bg-orange-600 transition-colors duration-200'
      ...
      {myShopData && (
        <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
          <h1 className='text-2xl sm:text-3xl text-gray-900 flex items-center gap-3 mt-8 text-center'>
            <LuVegan className='text-[#ff4d2d] w-14 h-14' />
            ...
            <div className='flex justify-center items-center p-4 sm:p-6'>
              <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
                <div className='flex flex-col items-center text-center'>
                  ...
                  <p className='text-gray-600 mb-4 text-sm sm:text-base'>
                    Share your products for our customers by adding them to the menu.
                  </p>
                  <button
                    className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font shadow-md hover:bg-orange-600 transition-colors duration-200'
