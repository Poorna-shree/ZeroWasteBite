...
const userSlice = createSlice({
  ...
  initialState: {
    ...
    searchItems: null,
    socket: null,
    donorData: null,     // donor profile
    receiverData: null,  // ✅ receiver profile
  },
  reducers: {
    ...
    setDonorData: (state, action) => { state.donorData = action.payload; },
    setReceiverData: (state, action) => { state.receiverData = action.payload; }, // ✅
  },
});
